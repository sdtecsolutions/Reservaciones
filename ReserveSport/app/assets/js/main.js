...
app.run(['$rootScope', '$state', '$stateParams', '$location', '$cookieStore',
function ($rootScope, $state, $stateParams, $location, $cookieStore) {
    ...
    $rootScope.app = {
        name: 'Reservaciones', // name of your project
        author: 'Tec Solutions', // author's name or company name
        description: 'Reservaciones', // brief description
